...
`,
    ...
    fs.unlinkSync(filepath); // it will delete the file from path folder as soon as it is analysised by our ai model
...
`,
    ...
    //generating questions in interview model
    const interview = await Interview.create({
      ...
      questions: questionsArray.map((q, index) => ({
        question: q,
        difficulty: ["medium", "medium", "medium", "hard", "hard"][index],
